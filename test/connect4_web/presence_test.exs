defmodule Connect4Web.PresenceTest do
  use ExUnit.Case, async: false
  doctest Connect4Web.Presence
  alias Connect4Web.Presence
  alias Connect4.Games.Game

  test "track_player/3 no existing game" do
    playera = Connect4.Games.Player.new(id: "a", name: "playera")
    playerb = Connect4.Games.Player.new(id: "b", name: "playerb")
