defmodule Mix4.GamesServerTest do
  use ExUnit.Case
  doctest Mix4.GamesServer
  ...
  test "join_queue/2 broadcast message to subscribers of game start" do
    ...
    Phoenix.PubSub.subscribe(Mix4.PubSub, "player:#{playera.id}")
    Phoenix.PubSub.subscribe(Mix4.PubSub, "player:#{playerb.id}")
